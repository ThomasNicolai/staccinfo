...
export default function ExtraFeatureDetailPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      ...
      <div
        className="absolute top-[-65px] left-[-170px] w-[390px] h-[390px]
                   rounded-full transform translate-x-1 translate-y-1/3
                   bg-gradient-to-b from-[hsl(var(--primary))] to-[hsl(var(--secondary))]
                   p-[55px] pointer-events-none z-[-1]"
      >
        <div className="w-full h-full rounded-full bg-background dark:bg-background" />
      </div>
